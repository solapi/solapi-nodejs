...
module.exports.put = (path, body = {}, options = {}) => {
...
module.exports.get = (path, qs = {}, options = {}) => {
  const headers = { Authorization: getAuth() }
  if (options.headers) {
    Object.assign(headers, options.headers)
    delete options.headers
...
/**
 * 그룹에 추가된 메시지 목록을 가져옵니다.
 * @param groupId 그룹 아이디
 */
module.exports.getGroupMessages = (groupId) => {
  return request({
    method: 'GET',
    uri: getUrl(`/messages/v4/groups/${groupId}/messages`),
    headers: { Authorization: getAuth() },
    json: true
  })
}
 ...
 * @param path 업로드할 파일경로
 */
module.exports.uploadRCSImage = async (path) => {
  return upload({
    file: await image2base64(path),
    type: 'RCS'
  })
